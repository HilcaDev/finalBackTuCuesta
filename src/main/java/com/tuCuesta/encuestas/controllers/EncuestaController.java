...
public class EncuestaController {
    ...
    public ResponseEntity<Map<String, String>> guardar(@RequestBody EncuestaModel encuesta){
    ...
    public List<EncuestaModel> mostrar(){
       return this.service.traerEncuestas();
    }
 
    //Metodo para actualizar la encuesta
     @PutMapping("/encuestas")
     public ResponseEntity<Map<String, String>> actualizar(@RequestBody EncuestaModel encuesta){
         this.service.guardarEncuesta(encuesta); //Invocamos el metodo creado en el servicio
